package interviewPracticeQuestions.utilities;
...
public class Driver {
    ...
    public static WebDriver get() {
       // System.out.println(" Driver.Get() methodu");
        //if this thread doesn't have driver - create it and add to pool
        if (driverPool.get() == null) {
            System.out.println("if driverpoll=null methodu");
...
//                        driverPool.set(new RemoteWebDriver(new URL("https://talhaOzleb:00e57530-66a9-462b-b293-a5268163fc34@ondemand.eu-central-1.saucelabs.com:443/wd/hub"),chromeOptions));
